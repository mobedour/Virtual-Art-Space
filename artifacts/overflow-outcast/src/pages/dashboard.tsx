...
export default function Dashboard() {
  ...
  if (!isLoaded || (user && isStatsLoading)) {
    return (
      <DashboardLayout>
      ...
      <PageEnter className="space-y-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground font-sans mt-1">Welcome back, {user.username ?? user.primaryEmailAddress?.emailAddress?.split("@")[0]}</p>
          </div>
